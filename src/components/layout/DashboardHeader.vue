<template>
  <header class="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 px-4 py-4 lg:px-6">
      ...
      <div class="flex-1 max-w-md ml-4 lg:ml-0">
        <div class="relative">
          ...
          <input
            type="text"
            placeholder="Search..."
            class="w-full pl-10 pr-4 py-2 bg-gray-50 dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent text-gray-900 dark:text-white text-sm"
          />
        </div>
      </div>
      ...
      <div class="flex items-center space-x-2 lg:space-x-4">
        ...
        <div class="relative">
          <button
            ...
            class="flex items-center space-x-2 text-left lg:space-x-3"
          >
